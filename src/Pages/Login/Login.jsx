  ...
  return (
    <div className="max-w-7xl mx-auto my-12  rounded-tl-[60px] rounded-tr-[60px] rounded-bl-[60px] rounded-br-[60px] bg-white dark:bg-gray-900 border border-[#11B719]">
      <div className="flex justify-center min-h-screen">
        <div
          className="hidden bg-cover lg:block lg:w-2/3 rounded-br-[60px] rounded-tr-[60px]"
          style={{
            backgroundImage:
              `url(${loginBgGif})`,
          }}
        >
          <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-50 rounded-tl-[60px] rounded-br-[60px] rounded-tr-[60px] rounded-bl-[60px]">
            <div>
            <h4 className="text-5xl font-lora font-bold">
